   ...
   <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
         <ul class="nav navbar-nav">
            ...
            <li><a href="<?php echo site_url('users')?>"> <i class="fa fa-users"></i> USUARIOS</a></li>
            <li><a href="<?php echo site_url('parametros')?>"> <i class="fa fa-cogs"></i> PARAMETROS</a></li>
            <li><a href="<?php echo site_url('contacts')?>"> <i class="fa fa-comments" aria-hidden="true"></i> CONTACTOS</a></li>            
         </ul>
