<div class="page-header">
  <h1> <i class="fa fa-credit-card" aria-hidden="true"></i>  Tarifas <small> listado general </small></h1>
</div>
<?php echo form_open()?>
	...
	<a data-url="<?php echo site_url("rates/agregar/" . $this->uri->segment(3))?>" class="btn btn-default btn-sm" data-toggle="modal" data-target="#myModal" data-title="Tarifas <small>agregar</small>" > <i class="fa fa-plus-square"></i> AGREGAR TARIFA </a>
