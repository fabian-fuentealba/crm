...
<div class="page-header">
	<h1> <b> Servicios</b> <small> listado general</small></h1>
</div>
...
<?php echo form_open()?>
	...
	<a data-url="<?php echo site_url("services/agregar")?>" class="btn btn-default btn-sm" data-toggle="modal" data-target="#myModal" data-title="AGREGAR SERVICIO" > <i class="fa fa-plus-square"></i> AGREGAR SERVICIO </a>
	...
	<div class="table-responsive">
		...
		foreach ($servicios as $key => $value) {
			...
			<tr >
				...
				<td ><a data-url="<?php echo site_url('services/editar/' . $value['id_servicio'])?>" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal" data-title="MODIFICAR SERVICIO" > <i class="fa fa-pencil-square-o"></i> </a></td>
				<td><?php echo ($value['estado'] == 1)?'<span class="label label-success">ACTIVO</span>':'<span class="label label-danger">INACTIVO</span>'?></td>
				<td><input type="checkbox" name="eliminar[]" value="<?php echo $value['id_servicio']?>"></td>
			</tr><?php
		}?>
		</table>
	</div>
