<?php echo form_open(NULL, array('class'=> 'form-horizontal'))?>
	...
	<div class="form-group">
		...
		<div class="col-md-10">
	    	<input type="text" name="plan" class="form-control" value="<?php echo set_value("plan")?>" placeholder="Nombre del plan" >
	    </div>			   
	</div>
	...
	<div class="form-group">
		...
		<div class="col-md-10">
	    	<input type="text" name="lugar" class="form-control" value="<?php echo set_value("lugar")?>" placeholder="Posicion al listar clientes" >
	    </div>			   
	</div>
	...
	<div class="form-group">
		...
		<div class="col-md-10">
			<div class="input-group">
	    		...
	    		<input type="text" name="valor" maxlength="6" class="form-control" value="<?php echo set_value("valor")?>" placeholder="Valor" >
	    	</div>
	    </div>			   
	</div>
	...
	<div class="form-group">
		...
		<div class="col-md-2">
	    	<input type="text" maxlength="3" name="duracion" class="form-control" value="<?php echo set_value("duracion")?>" placeholder="Duracion en dias del plan" >
	    </div>
	    <div class="col-md-8">
