<div class="page-header">
  <h1> <i class="fa fa-users"></i> Usuarios <small> detalle perfil </small></h1>
</div>
...
<?php echo form_open(NULL, array('class'=> 'form-horizontal'))?>
	...
	<div class="form-group">
		<label class="col-md-2 label-control">POSICIÓN</label>
		<div class="col-md-2">
	    	<input type="number" min="1" class="form-control" name="posicion" value="<?php echo $usuario['posicion']?>" maxlength="2" placeholder="99">
	    </div>
	</div>
	...
	<div class="form-group">
		<label class="col-md-2 label-control">CATEGORIA <i class="fa fa-asterisk text-primary"></i> </label>
		<div class="col-md-10">
	    	<select class="form-control" name="categoria" id="pais">
	    		<option value=""></option>
		    	<optgroup label="Paises"><?php
		    	foreach ($categorias as $key => $value) {
		    		?>
		    		<option value="<?php echo $value['id_categoria']?>" <?php echo ($usuario['id_categoria'] == $value['id_categoria'])?'selected':'';?> ><?php echo $value['categoria']?></option><?php
		    	}?>				    		
		    	</optgroup>
	    	</select>
	    </div>
